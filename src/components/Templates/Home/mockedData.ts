export const mockedPage1 = [
  ...
  },
  {
    ...
    tags: [
      'assado',
      {
        chef: {
          nome: 'Felipe Bronze',
          programa: 'Perto do Fogo',
        },
      },
      'Rita Lobo',
      {
        acompanhamentos: ['arroz', 'purê', 'salada', 'arroz', 'omelete'],
      },
      {
        chef: {
          nome: 'Rodrigo Hilbert',
          programa: 'Tempero de Família',
        },
      },
      {
        bebidas: ['suco', 'coquetel'],
      },
      'Salada',
      'Fritura',
      {
        semana: {
          segunda: 'Em tempo real',
          terca: 'Desgourmetiza',
          quarta: 'Reaproveitamento',
          quinta: 'Dia de Feira',
          sexta: 'Cozinhas: A Dois',
        },
      },
      'Felipe Bronze',
      {
  ...
  },
  {
    ...
    section: 'Planeta Bizarro',
    summary: 'Ela afirmou que noiva e convidados encararam bem a brincadeira.',
    title:
  ...
  {
    chapeu: '',
    image: 'https://s.glbimg.com/jo/g1/f/original/2013/03/23/1-holanda.jpg',
    section: 'Planeta Bizarro',
    summary:
